...
--
-- Ersättningsstruktur för vy `3_ongoing_auctions`
...
--
-- Ersättningsstruktur för vy `5_auction_creator`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `6_latest_bid`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `8_reserved_price_reached`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `9_latest_publ_auction`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `10_auction_ending_first`
-- (See below for the actual view)
--
...
(3, 88, 65, 39281, '2020-03-27 20:17:07'),
(4, 91, 29, 85367, '2020-04-24 05:47:26'),
(5, 3, 88, 5591, '2020-04-24 22:38:56'),
(6, 3, 66, 3236, '2020-03-18 02:11:57'),
...
(11, 3, 31, 6111, '2020-04-25 10:10:00'),
(12, 3, 12, 6423, '2020-04-25 13:10:00'),
(13, 1, 91, 55000, '2020-03-21 13:58:19'),
(14, 1, 52, 100000, '2020-04-25 10:10:00'),
(15, 2, 3, 9000, '2020-04-06 13:58:19'),
(16, 2, 43, 11232, '2020-04-08 13:58:19'),
(17, 56, 97, 94693, '2020-03-22 12:58:18'),
(18, 56, 97, 94693, '2020-03-22 12:58:18'),
(19, 56, 97, 94693, '2020-03-22 12:58:18');
...
(1, 'Chaetomium', 17, 'Drainage of Right Hand Tendon, Percutaneous Approach', 'http://dummyimage.com/222x148.bmp/dddddd/000000', 23544, '2020-03-17 00:00:00', '2020-04-17 10:09:12'),
(2, 'Hydroxychloroquine Sulfate', 20, 'LDR Brachytherapy of Inguinal Lymph using Oth Isotope', 'http://dummyimage.com/226x188.bmp/5fa2dd/ffffff', 8, '2020-03-17 00:00:00', '2020-04-19 09:22:27'),
(3, 'Dove', 77, 'Drainage of Splenic Artery, Open Approach, Diagnostic', 'http://dummyimage.com/182x109.png/5fa2dd/ffffff', 359, '2020-03-17 00:00:00', '2020-03-19 15:20:40'),
(4, 'Natural Fiber Therapy Natural Laxative', 62, 'Bypass Lower Esophagus to Stomach with Nonaut Sub, Endo', 'http://dummyimage.com/183x187.bmp/dddddd/000000', 6503, '2020-03-17 00:00:00', '2020-04-09 17:43:43'),
(5, 'Potassium Chloride', 41, 'Drainage of Right Lobe Liver with Drain Dev, Open Approach', 'http://dummyimage.com/130x223.jpg/dddddd/000000', 238, '2020-03-17 00:00:00', '2020-04-29 08:09:42'),
(6, 'bronze-n-brighten', 45, 'Irrigation of Ear using Irrigat, Perc Approach, Diagn', 'http://dummyimage.com/236x219.bmp/5fa2dd/ffffff', 2708, '2020-03-17 00:00:00', '2020-04-25 00:00:00'),
...
(9, 'Amantadine HCl', 7, 'Drainage of Right Upper Femur, Percutaneous Approach, Diagn', 'http://dummyimage.com/207x101.jpg/5fa2dd/ffffff', 843, '2020-03-12 00:00:00', '2020-05-17 00:00:00'),
(10, 'Lactovit Lactourea ROLL-ON DEODORANT ANTIPERSPIRANT', 83, 'Replace of R Sphenoid Bone with Nonaut Sub, Open Approach', 'http://dummyimage.com/169x210.bmp/cc0000/ffffff', 6279, '2020-03-13 00:00:00', '2020-05-17 00:00:00'),
(11, 'Skin Doctors Photo Age Reverse Night Serum', 72, 'Supplement Small Intestine with Autol Sub, Via Opening', 'http://dummyimage.com/175x153.jpg/cc0000/ffffff', 99999, '2020-03-14 00:00:00', '2020-05-17 00:00:00'),
(12, 'Infergen', 18, 'Drainage of R Int Iliac Art, Perc Endo Approach, Diagn', 'http://dummyimage.com/246x150.jpg/dddddd/000000', 44598, '2020-03-15 00:00:00', '2020-05-17 00:00:00'),
(13, 'BIOWHITE BRIGHTENING', 87, 'Exercise Treatment of Resp Low Back/LE using Oth Equip', 'http://dummyimage.com/174x232.png/dddddd/000000', 6880, '2020-03-16 00:00:00', '2020-05-17 00:00:00'),
(14, 'Magnesium Sulfate', 1, 'Removal of Synth Sub from L Humeral Shaft, Open Approach', 'http://dummyimage.com/113x201.bmp/cc0000/ffffff', 1092, '2020-03-17 00:00:00', '2020-05-17 00:00:00'),
...
(23, 'dicyclomine hydrochloride', 30, 'Repair Cervical Nerve, Open Approach', 'http://dummyimage.com/147x181.bmp/dddddd/000000', 689, '2020-04-17 00:00:00', '2020-05-17 00:00:00'),
(24, 'Cefazolin', 72, 'Supplement Left Trunk Muscle with Autol Sub, Open Approach', 'http://dummyimage.com/222x221.png/cc0000/ffffff', 90623, '2020-04-18 00:00:00', '2020-05-17 00:00:00'),
(25, 'Zaditor', 40, 'Replace R Sphenoid Bone w Synth Sub, Perc Endo', 'http://dummyimage.com/243x169.jpg/5fa2dd/ffffff', 18, '0000-00-00 00:00:00', '2020-05-17 00:00:00'),
(26, 'PM pain reliever', 76, 'Occlusion R Thyroid Art w Intralum Dev, Perc Endo', 'http://dummyimage.com/234x180.jpg/cc0000/ffffff', 46, '2020-03-25 00:00:00', '2020-05-17 00:00:00'),
(27, 'Valium', 54, 'Extirpation of Matter from GI Tract, Via Opening', 'http://dummyimage.com/118x199.jpg/dddddd/000000', 1762, '2020-04-12 00:00:00', '2020-05-17 00:00:00'),
...
(38, 'CLINIQUE', 66, 'Repair Right Foot, External Approach', 'http://dummyimage.com/118x121.png/5fa2dd/ffffff', 14681, '2020-03-17 00:00:00', '2020-05-17 00:00:00'),
...
(46, 'Common Cold', 90, 'Drainage of Pelvic Subcu/Fascia, Perc Approach', 'http://dummyimage.com/199x126.jpg/5fa2dd/ffffff', 622, '2020-03-17 00:00:00', '2020-05-17 00:00:00'),
(47, 'Gemfibrozil', 98, 'Fluoroscopy L Low Extrem Vein w Oth Contrast, Guidance', 'http://dummyimage.com/181x231.jpg/5fa2dd/ffffff', 94, '2020-03-17 00:00:00', '2020-05-16 00:00:00'),
(48, 'Doxazosin', 18, 'Supplement Esophagast Junct w Autol Sub, Perc Endo', 'http://dummyimage.com/151x189.bmp/cc0000/ffffff', 61490, '2020-03-17 00:00:00', '2020-05-15 00:00:00'),
(49, 'Hydrocodone Bitartrate and Acetaminophen', 86, 'Revise Autol Sub in Head & Neck Subcu/Fascia, Extern', 'http://dummyimage.com/127x141.jpg/5fa2dd/ffffff', 2419, '2020-03-17 00:00:00', '2020-05-14 00:00:00'),
(50, 'Aurum Lavender Rose', 53, 'Transfuse of Autol Factor IX into Periph Vein, Open Approach', 'http://dummyimage.com/118x249.bmp/cc0000/ffffff', 11451, '2020-03-17 00:00:00', '2020-05-13 00:00:00'),
(51, 'Advanced Dual Complex Fade', 85, 'Repair Left Superior Parathyroid Gland, Perc Endo Approach', 'http://dummyimage.com/139x230.bmp/cc0000/ffffff', 17219, '2020-03-17 00:00:00', '2020-05-12 00:00:00'),
...
(75, 'Enalapril Maleate', 58, 'Supplement Right Renal Vein with Nonaut Sub, Open Approach', 'http://dummyimage.com/172x245.jpg/dddddd/000000', 97520, '2020-03-17 00:00:00', '2020-05-17 00:00:00'),
...
(88, 'BiferaRx', 32, 'Drainage of Left Foot Tendon, Percutaneous Approach', 'http://dummyimage.com/159x128.jpg/5fa2dd/ffffff', 97000, '2020-03-17 00:00:00', '2020-05-17 00:00:00'),
...
(101, 'Chaetomium', 17, 'Drainage of Right Hand Tendon, Percutaneous Approach', 'http://dummyimage.com/222x148.bmp/dddddd/000000', 23544, '2020-03-16 23:00:00', '2020-04-17 08:09:12'),
(102, 'Chaetomium', 17, 'Drainage of Right Hand Tendon, Percutaneous Approach', 'http://dummyimage.com/222x148.bmp/dddddd/000000', 23544, '2020-03-16 23:00:00', '2020-04-17 08:09:12'),
(103, 'Chaetomium', 17, 'Drainage of Right Hand Tendon, Percutaneous Approach', 'http://dummyimage.com/222x148.bmp/dddddd/000000', 23544, '2020-03-16 23:00:00', '2020-04-17 08:09:12'),
(104, 'Chaetomium', 17, 'Drainage of Right Hand Tendon, Percutaneous Approach', 'http://dummyimage.com/222x148.bmp/dddddd/000000', 23544, '2020-03-16 23:00:00', '2020-04-17 08:09:12'),
(105, 'Chaetomium', 17, 'Drainage of Right Hand Tendon, Percutaneous Approach', 'http://dummyimage.com/222x148.bmp/dddddd/000000', 23544, '2020-03-16 23:00:00', '2020-04-17 08:09:12'),
(106, 'Chaetomium', 17, 'Drainage of Right Hand Tendon, Percutaneous Approach', 'http://dummyimage.com/222x148.bmp/dddddd/000000', 23544, '2020-03-16 23:00:00', '2020-04-17 08:09:12');
...
--
-- Struktur för vy `3_ongoing_auctions`
--
...
--
-- Struktur för vy `5_auction_creator`
--
...
--
-- Struktur för vy `8_reserved_price_reached`
--
...
--
-- Struktur för vy `9_latest_publ_auction`
--
DROP TABLE IF EXISTS `9_latest_publ_auction`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `9_latest_publ_auction`  AS  select `items`.`item_id` AS `item_id`,`items`.`item_name` AS `item_name`,`items`.`seller_id` AS `seller_id`,`items`.`item_desc` AS `item_desc`,`items`.`item_img` AS `item_img`,`items`.`reserved_price` AS `reserved_price`,`items`.`auction_start` AS `auction_start`,`items`.`auction_end` AS `auction_end` from `items` where `items`.`auction_start` <> 0 order by `items`.`auction_start` desc ;

-- --------------------------------------------------------

--
-- Struktur för vy `10_auction_ending_first`
--
DROP TABLE IF EXISTS `10_auction_ending_first`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `10_auction_ending_first`  AS  select `items`.`item_id` AS `item_id`,`items`.`item_name` AS `item_name`,`items`.`seller_id` AS `seller_id`,`items`.`item_desc` AS `item_desc`,`items`.`item_img` AS `item_img`,`items`.`reserved_price` AS `reserved_price`,`items`.`auction_start` AS `auction_start`,`items`.`auction_end` AS `auction_end` from `items` where `items`.`auction_end` <> 0 order by `items`.`auction_end` ;
...
--
ALTER TABLE `bids`
  MODIFY `bid_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT för tabell `items`
--
ALTER TABLE `items`
  MODIFY `item_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
