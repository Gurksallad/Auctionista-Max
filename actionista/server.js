...
app.post("/data/items", async (req, res) => {
  console.log("req.body", req.body)
  let query = "INSERT INTO items SET item_name = ?, seller_id = ?, item_desc = ?, item_img = ?, reserved_price = ?, auction_start = ?, auction_end = ?"
  let result = await db.query(query, [req.body.item_name, req.body.seller_id,req.body.item_desc,req.body.item_img,req.body.reserved_price,req.body.auction_start,req.body.auction_end])
  res.json(result)
})

app.post("/data/bids", async (req, res) => {
  console.log("req.body", req.body)
  let query = "INSERT INTO bids SET bid_item = ?, bid_price = ?, bid_time = ?, bid_user = ?"
  let result = await db.query(query, [req.body.bid_item, req.body.bid_price,req.body.bid_time,req.body.bid_user])
  res.json(result)
})
/////////////////
